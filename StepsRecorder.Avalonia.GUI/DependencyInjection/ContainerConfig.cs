...
namespace StepsRecorder.Avalonia.GUI.DependencyInjection
{
    public static class ContainerConfig
    {
        ...
        {
            //Link up all ViewModels within StepsRecorder.Avalonia.GUI.ViewModels with the corresponding interfaces. Name-Convention I<NAMEOFTYPE> required
